# Copy from torchvision.models.detection.roi_heads sliently change
...
class RoIHeads(nn.Module):
    ...
    def forward(
        ...
        if self.training and inverted_feature_map is not None: # 只有在训练过程中使用Inverted_attention_map
            box_features=box_features*inverted_feature_map
